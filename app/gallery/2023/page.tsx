...
export default function Gallery2023Page() {
  ...
  const openLightbox = (index: number) => {
    ...
    setSelectedImage(images2023[index].src)
  }
  ...
  const goToPrevious = () => {
    const newIndex = (selectedIndex - 1 + images2023.length) % images2023.length
    setSelectedIndex(newIndex)
    setSelectedImage(images2023[newIndex].src)
  }

  const goToNext = () => {
    const newIndex = (selectedIndex + 1) % images2023.length
    setSelectedIndex(newIndex)
    setSelectedImage(images2023[newIndex].src)
  }
        ...
        >
          ...
          <div className="relative max-w-5xl max-h-[80vh]">
            <Image
              ...
              alt={images2023[selectedIndex]?.alt || "Immagine ingrandita"}
              width={1200}
              height={800}
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 mb-8">
            <Link href="/gallery" className="text-white hover:underline flex items-center">
