          ...
          <div className="mb-12">
            ...
            <div className="mb-16">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-6">
                ...
                <Link href="/gallery/2024" className="text-white mt-2 md:mt-0 flex items-center hover:underline">
            ...
            <div className="mb-16">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-6">
                ...
                <Link href="/gallery/2023" className="text-white mt-2 md:mt-0 flex items-center hover:underline">
